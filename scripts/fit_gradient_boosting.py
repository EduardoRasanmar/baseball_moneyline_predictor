"""
Fit a gradient boosting (XGBoost) model to predict home team win (home_win).
...
FEATURE_COLS = [
    ...
    # Rolling pitching (ERA, WHIP, K/9, BB/9, HR/9)
...
def main():
    ...
    print("\nFitting gradient boosting (XGBoost)...")
    ...
    joblib.dump(
        ...
        MODELS_DIR / "gradient_boosting_meta.pkl",
    )
    ...
    importance_path = PROJECT_ROOT / "results" / "tables" / "gradient_boosting_feature_importance.csv"
